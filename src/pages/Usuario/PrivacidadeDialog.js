    ...
    <div>
      <Dialog onClose={p.handleClose} aria-labelledby="customized-dialog-title" open={p.open}>
        ...
        <DialogContent dividers>
          <p>A sua privacidade é importante para nós. É política do Dental Diet respeitar a sua privacidade em relação 
          a qualquer informação sua que possamos coletar no site <a href="https://dentaldiet.web.app/">Dental Diet</a>, 
          ...
          Fazemos por meios justos e legais, com o seu conhecimento e consentimento. Também informamos porque 
          ...
          e informações pessoais, entre em contato conosco.</p>
          
          <h2>Política de Cookies Dental Diet</h2>                    
          ...
          como as usamos e porque às vezes precisamos armazenar esses cookies. Também compartilharemos como você pode 
          ...
          <ul style={{marginLeft: '30px'}}>      
            ...
            em alguns casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao sair.<br/><br/>                       
            </li>                        
            ...
            lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas 
            ...
            Quando você envia dados por meio de um formulário como os encontrados nas páginas de contato 
            ...
            com uma página for afetada por suas preferências.<br/>
            </li>                        
          </ul>
          ...
          <ul style={{marginLeft: '30px'}}>
            <li> As análises de terceiros são usadas para rastrear e medir o uso deste site, para que possamos continuar 
              ...
              ou as páginas visitadas, o que nos ajuda a entender como podemos melhorar o site para você.
            </li>
            <li> Periodicamente, testamos novos recursos e fazemos alterações subtis na maneira como o site se apresenta. 
              ...
              uma experiência consistente enquanto estiver no site, enquanto entendemos quais otimizações 
              os nossos usuários mais apreciam.
            </li>
            <li> À medida que vendemos produtos, é importante entendermos as estatísticas sobre quantos visitantes 
              ...
              Isso é importante para você, pois significa que podemos fazer previsões de negócios com precisão que nos 
              permitem analizar nossos custos de publicidade e produtos para garantir o melhor preço possível.
            </li>
          </ul>
          ...
          Esta política é efetiva a partir de <strong>Dezembro</strong>/<strong>2020</strong>.
        </DialogContent>
      </Dialog>
    </div>
  );
